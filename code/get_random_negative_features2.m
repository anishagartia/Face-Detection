...
function features_neg = get_random_negative_features2(non_face_scn_path, feature_params, num_samples)
...
fprintf('\nGetting negative features: image       ');
k = 0;
for i = 1:num_images
    ...
    for j = 1:num_of_patchs
       ...
       this_feat =  get_hog_feat(im2single(this_patch), feature_params.hog_cell_size);
